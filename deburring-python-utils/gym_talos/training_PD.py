...
from gym_talos.envs.env_talos_pd_deburring import EnvTalosPosition, EnvTalosPositionHER
...
parser.add_argument(
    "-config",
    "--configurationFile",
    default=(Path(__file__).resolve().parent / "config/config_PD_RL.yaml"),
    required=False,
